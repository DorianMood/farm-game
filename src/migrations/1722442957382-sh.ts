...
export class Sh1722442957382 implements MigrationInterface {
    name = 'Sh1722442957382'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."inventory_item_category_enum" AS ENUM('Seed', 'Animal', 'SeedProduct', 'AnimalProduct', 'PromoCode', 'Fertilizer')`);
