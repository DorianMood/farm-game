...
export class Sh1720784395442 implements MigrationInterface {
    name = 'Sh1720784395442'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "animal_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."animal_product_type_enum" NOT NULL, "inventoryItemId" uuid, CONSTRAINT "UQ_5a6a6a2cde5fc23c60aa8934cff" UNIQUE ("type"), CONSTRAINT "REL_5f09449719fef5d756ce698c2d" UNIQUE ("inventoryItemId"), CONSTRAINT "PK_148dc2b33cada00239ec5436cb2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."seed_product_type_enum" AS ENUM('Carrot', 'Flower', 'Potato', 'Wheat', 'Beet')`);
        await queryRunner.query(`CREATE TABLE "seed_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."seed_product_type_enum" NOT NULL, "inventoryItemId" uuid, CONSTRAINT "UQ_56cf0998070719179af5ce2b771" UNIQUE ("type"), CONSTRAINT "REL_d5b4e0b8b02e161cfee6243dc4" UNIQUE ("inventoryItemId"), CONSTRAINT "PK_8b952652c71778abd12d322c04b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."inventory_item_category_enum" AS ENUM('Seed', 'Animal', 'SeedProduct', 'AnimalProduct')`);
        await queryRunner.query(`CREATE TABLE "inventory_item" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" text NOT NULL, "price" integer NOT NULL, "sellMultiplier" integer NOT NULL, "category" "public"."inventory_item_category_enum", CONSTRAINT "PK_94f5cbcb5f280f2f30bd4a9fd90" PRIMARY KEY ("id"))`);
