...
export class Sh1722462113192 implements MigrationInterface {
    name = 'Sh1722462113192'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "fertilizer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "inventoryItemId" uuid, CONSTRAINT "REL_c4b309b909b74fb43267a43f66" UNIQUE ("inventoryItemId"), CONSTRAINT "PK_3d0704e83bef3b07de441b2f47a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "vitamin" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "inventoryItemId" uuid, CONSTRAINT "REL_c9072eebb7701723b9e30ed684" UNIQUE ("inventoryItemId"), CONSTRAINT "PK_318c9ad38b3c5892e2eb98ab780" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."inventory_item_category_enum" AS ENUM('Seed', 'Animal', 'SeedProduct', 'AnimalProduct', 'PromoCode', 'Fertilizer', 'Vitamin')`);
        ...
        await queryRunner.query(`ALTER TABLE "fertilizer" ADD CONSTRAINT "FK_c4b309b909b74fb43267a43f66d" FOREIGN KEY ("inventoryItemId") REFERENCES "inventory_item"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vitamin" ADD CONSTRAINT "FK_c9072eebb7701723b9e30ed6844" FOREIGN KEY ("inventoryItemId") REFERENCES "inventory_item"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vitamin" DROP CONSTRAINT "FK_c9072eebb7701723b9e30ed6844"`);
        await queryRunner.query(`ALTER TABLE "fertilizer" DROP CONSTRAINT "FK_c4b309b909b74fb43267a43f66d"`);
        ...
        await queryRunner.query(`DROP TABLE "vitamin"`);
